...
receipt age so the hourly Worker cleanup can prune entries after seven days. Apply both migrations
before deploying the Worker that serves move-receipt lookups.
