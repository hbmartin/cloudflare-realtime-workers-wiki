...
including moves from older browser bundles. Apply `0010` before enabling the hourly retention cleanup so
that pruning does not scan the full receipt table.
