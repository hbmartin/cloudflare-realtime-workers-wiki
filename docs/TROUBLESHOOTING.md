...
| `Page move batch result was invalid or inconsistent.`         | D1 returned malformed metadata or a result that contradicted the read-back state. Inspect `moveError*`; `recoveredFromReceipt` shows whether the response was recovered from the authoritative receipt                                                                   |
