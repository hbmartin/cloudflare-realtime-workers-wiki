...
| `Page move batch result was invalid.`                         | D1 committed the move and stored receipt, but returned malformed result metadata. The response was recovered from that receipt; inspect `moveError*`                                                                                                                     |
