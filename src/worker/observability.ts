...
const SECRET_VALUE = /\b(?:sk|crn|ghp|github_pat|xox[baprs])_[A-Za-z0-9_-]{8,}\b/gi;
...
function safeField(key: string, value: unknown): string | number | boolean | null | undefined {
  ...
  if (typeof value === "string")
    return redactedString(value, key.toLowerCase().endsWith("id") ? LOG_IDENTIFIER_LIMIT : LOG_TEXT_LIMIT);
